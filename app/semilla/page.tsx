    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative h-screen w-full">
          <img src="/semilla/velero/hero.jpg" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <section className="py-20 px-6 bg-white">
          <div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto">
            ...
            {/* RESERVA */}
            <div className="p-6 border rounded-xl text-center flex flex-col items-center gap-4">
              <img src="/shared/icono-reserva.png" className="w-12 h-12" />

              <h3 className="font-semibold text-xl">Reserva</h3>
            ...
            {/* GALERÍA */}
            <div className="p-6 border rounded-xl text-center flex flex-col items-center gap-4">
              <h3 className="font-semibold text-xl">Galería</h3>

              <p className="text-gray-600">
                Momentos reales en el lago
              </p>

              <Link href="/semilla/galeria">
                <img
            ...
            {/* CONSULTA */}
            <div className="p-6 border rounded-xl text-center flex flex-col items-center gap-4">
              <img src="/shared/icono-consulta.png" className="w-12 h-12" />

              <h3 className="font-semibold text-xl">Consulta</h3>
              ...
              <a
                href="https://wa.me/549XXXXXXXXXX?text=Hola!%20Quiero%20consultar%20sobre%20el%20paseo%20en%20velero%20para%20mi%20familia"
                target="_blank"
                className="bg-green-500 text-white px-5 py-2 rounded-lg text-sm"
              >
                Consultar
